...
public class SRS {
	...
	public static ArrayList<Students> studentBody; 
	...
	public static void main(String[] args) {
		...
		s1 = new Students("111","Joe Blow", "111-11-1111", "Math", "M.S.");

		s2 = new Students("222","Fred Schnurd", "222-22-2222", 
				 "Information Technology", "Ph. D.");

		s3 = new Students("333","Mary Smith", "333-33-3333", "Physics", "B.S.");

		// Add these to the appropriate ArrayList.

		studentBody = new ArrayList<Students>();
		studentBody.add(s1);
		studentBody.add(s2);
		studentBody.add(s3);
...
//		c4.setPrerequisite(c3); 
	...
	private static void attemptToEnroll(Students s, Section sec) {
